...
def pack(
        ...
        faces:torch.Tensor, #F,3 long, 0 for unused, 
        vt: torch.Tensor=None, #V,3
        ft: torch.Tensor=None, #F,3 long, 
        with_dummy:bool=True,
        return_used_vertices:bool=False,
    ...
    if vt is not None and ft is not None:
        ...
        ft = ft[used_faces]
        ft = ind[ft]
        if return_used_vertices: 
            return vertices,faces,vt,ft, used_vertices
        return vertices,faces,vt,ft
